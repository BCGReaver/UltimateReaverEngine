 ...
 * @brief Encapsula un @c ID3D11RenderTargetView en Direct3D 11.
 *
 * Un Render Target View (RTV) representa una superficie donde la GPU
 * puede dibujar (el destino del pipeline de renderizado).
 *
 * Se utiliza principalmente para:
 * - El back buffer de la ventana (swap chain).
 * - Buffers auxiliares (G-Buffer, render targets para post-procesado).
 * - Texturas para efectos especiales (mapas de sombra, reflejos, etc.).
 */
class
  RenderTargetView {
public:
